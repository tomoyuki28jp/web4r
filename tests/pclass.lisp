...
(test slot-save-value
  (with-post-parameters
      '(("testdb1_name" . "tomoyuki matsumoto")
        ...
        ("testdb1_birth_date-Y" . "1983")
        ("testdb1_birth_date-M" . "9")
        ("testdb1_birth_date-D" . "28")
...
(test class-validation-errors
  ...
  ; required
  (with-post-parameters '(("birth_date-Y" . "")
                          ("birth_date-M" . "")
                          ("birth_date-D" . ""))
    ...
    (let ((i (progn
      ...
      (with-post-parameters
          '(("testdb1_name" . "Tomoyuki Matsumoto2")
            ...
            ("testdb1_birth_date-Y" . "1982")
            ("testdb1_birth_date-M" . "8")
            ("testdb1_birth_date-D" . "27")
